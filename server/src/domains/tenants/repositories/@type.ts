...
export interface ITenatsRepositories{
  ...
  update(data : Omit<CreateCompanieDTo , "password"> , id : string) : Promise<ITenantDefaultReturnType | null>
  ...
  get(cursor :number , limit :number) :Promise<IPAginationGet<Companies>>
