...
export default function ComapnieLayout({ children }: { children: ReactNode }) {
  ...
  const navs = [
    ...
    },
    {
      ...
      to: "/dashboard/companie/settings",
    },
  ];
  ...
  return (
    <main className="flex flex-col gap-4">
      <header className="fixed z-33 flex items-center border-b justify-between w-full left-0 top-0 md:p-4 py-2 bg-transparent backdrop-blur-xl">
        <Logo />
        <div>
      ...
      <section className="min-h-screen md:py-30 py-22 md:px-4 px-2">{children}</section>
